    ...
    <section id="demos" class="section section-no-border   section-light position-relative z-index-5 pt-0 m-0">
        ...
        <div class="container-fluid position-relative">
            ...
            <div class="row portfolio-list sort-destination sort-destination-margin sort-destination-items-hardware-acc overflow-visible mt-4" data-sort-id="portfolio">
                ...
                <div class="col-lg-12 isotope-item earthquake">
                    ...
                    <section class="section section-no-border section-angled  p-0 m-0"
                ...
                <div class=" col-lg-12 isotope-item fire">
                    ...
                    <section class="section section-no-border section-angled  pb-0 m-0"
                        style="background-repeat: no-repeat; background-color: #0b9440 !important;"
                        data-src="img/landing/reason_bg.png">
                        <div class="section-angled-layer-top section-angled-layer-increase-angle" style="padding: 2rem 0; background-color: #ffffff;"></div>
